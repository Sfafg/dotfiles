...
ClippingRectangle {
    ...
    border.color: activeFocus ? Theme.selectedBorder : "transparent"
    Keys.onPressed: (event) => {
        ...
        case Navigation.select:
            ...
            onClick();
            break;
        case Navigation.selectAlternative:
            if (onIconClick)
                onIconClick();
    ...
    Rectangle {
        ...
        color: isActive ? Qt.rgba(Theme.accent1.r, Theme.accent1.g, Theme.accent1.b, 0.3) : Qt.rgba(Theme.primary2.r, Theme.primary2.g, Theme.primary2.b, 0.3)
